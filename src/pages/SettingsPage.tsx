...
import { User, Shield, Camera, Save, Mail, Phone, MapPin, X, Check } from 'lucide-react';
  ...
  useEffect(() => {
    if (currentUser) {
      setFormData({
        ...
        phone: (currentUser as any).phone_number || (currentUser as any).phone || '',
        location: 'Metro Manila, Philippines'
      });
    }
  }, [currentUser]);
            ...
            <div className="p-8 text-center">
              ...
              {saveMessage.text && (
                <div className={cn(
                  ...
                  saveMessage.type === 'error' ? "bg-red-50 text-red-600 border border-red-200" : "bg-green-50 text-green-600 border border-green-200"
                )}>
                  {saveMessage.text}
                </div>
              )}
